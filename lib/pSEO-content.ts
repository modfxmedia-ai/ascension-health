  ...
  return [
    {
      ...
      answer: `Yes, Ascension Health offers ${sLow} from our Fernley, NV clinic at 415 HWY 95A Suite 503, serving patients from ${c} and the wider ${city.region} area. Same-week appointments are usually available.`,
    },
    {
      question: `How far is Ascension Health from ${c}?`,
      answer: `Ascension Health is located in Fernley, NV, at 415 HWY 95A Suite 503. Distances vary by starting point in ${c}, so we recommend checking your route in Google Maps. We coordinate appointment times so patients from ${c} aren't making the trip more often than necessary, and we offer evening flexibility when needed.`,
    },
    {
